...
public class page5 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>"+"WELCOME TO PAGE 5 "+s1+"</h1>");
             out.println("<a href=page1> Click here to visit page1</a><br>");
             out.println("<a href=page2> Click here to visit page2</a><br>");
             out.println("<a href=page3> Click here to visit page2</a><br>");
             out.println("<a href=page4> Click here to visit page2</a><br>");
